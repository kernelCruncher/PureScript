...
+ The fourth project, "Green", is just code from an online tuutorial. The functionality is quite simple: the user inputs text into a textbox and sees the same text appear above the input. This employs some more advanced concepts, like the Foreign Fucntion Interface. 

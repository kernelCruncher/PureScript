...
(function($PS) {
  ...
  var SelectColour = (function () {
      function SelectColour(value0) {
          this.value0 = value0;
      };
      SelectColour.create = function (value0) {
          return new SelectColour(value0);
      };
      return SelectColour;
  })();
  var maybeColors = function (v) {
      if (v instanceof Data_Maybe.Just) {
          return v.value0;
      };
      if (v instanceof Data_Maybe.Nothing) {
          return Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(8)(Color_Scheme_Clrs.gray);
      };
      throw new Error("Failed pattern match at Main (line 88, column 1 - line 88, column 50): " + [ v.constructor.name ]);
  };
  var justColor = function (v) {
      if (v instanceof Data_Maybe.Just) {
          return v.value0;
      };
      if (v instanceof Data_Maybe.Nothing) {
      ...
      throw new Error("Failed pattern match at Main (line 53, column 1 - line 53, column 34): " + [ v.constructor.name ]);
  };
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(state.but), Halogen_HTML_CSS.style(CSS_Background.backgroundColor(justColor(Data_Array.index(state.colours)(0)))), Halogen_HTML_Events.onClick(function (v) {
          return new SelectColour(1);
      }) ])([ Halogen_HTML_Core.text("Button 1") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(state.but), Halogen_HTML_CSS.style(CSS_Background.backgroundColor(justColor(Data_Array.index(state.colours)(1)))), Halogen_HTML_Events.onClick(function (v) {
          return new SelectColour(2);
      }) ])([ Halogen_HTML_Core.text("Button 2") ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(state.but), Halogen_HTML_CSS.style(CSS_Background.backgroundColor(justColor(Data_Array.index(state.colours)(2)))), Halogen_HTML_Events.onClick(function (v) {
          return new SelectColour(3);
      }) ])([ Halogen_HTML_Core.text("Button 3") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(state.but), Halogen_HTML_CSS.style(CSS_Background.backgroundColor(justColor(Data_Array.index(state.colours)(3)))), Halogen_HTML_Events.onClick(function (v) {
          return new SelectColour(4);
      }) ])([ Halogen_HTML_Core.text("Button 4") ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(state.but), Halogen_HTML_CSS.style(CSS_Background.backgroundColor(justColor(Data_Array.index(state.colours)(4)))), Halogen_HTML_Events.onClick(function (v) {
          return new SelectColour(5);
      }) ])([ Halogen_HTML_Core.text("Button 5") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(state.but), Halogen_HTML_CSS.style(CSS_Background.backgroundColor(justColor(Data_Array.index(state.colours)(5)))), Halogen_HTML_Events.onClick(function (v) {
          return new SelectColour(6);
      }) ])([ Halogen_HTML_Core.text("Button 6") ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(state.but), Halogen_HTML_CSS.style(CSS_Background.backgroundColor(justColor(Data_Array.index(state.colours)(6)))), Halogen_HTML_Events.onClick(function (v) {
          return new SelectColour(7);
      }) ])([ Halogen_HTML_Core.text("Button 7") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(state.but), Halogen_HTML_CSS.style(CSS_Background.backgroundColor(justColor(Data_Array.index(state.colours)(7)))), Halogen_HTML_Events.onClick(function (v) {
          return new SelectColour(8);
      }) ])([ Halogen_HTML_Core.text("Button 8") ]) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
          return Play.value;
  ...
  var initialState = function (v) {
      return {
          ...
          env: [  ],
          but: true,
          colours: Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(8)(Color_Scheme_Clrs.gray)
      };
  };
  var colourString = function (i) {
      return "colour" + Data_Show.show(Data_Show.showInt)(i);
  };
  var colorConverter = function (v) {
      if (v instanceof GameEnvironment.Blue) {
          return Color_Scheme_Clrs.blue;
      };
      if (v instanceof GameEnvironment.Red) {
          return Color_Scheme_Clrs.red;
      };
      if (v instanceof GameEnvironment.Green) {
          return Color_Scheme_Clrs.green;
      };
      if (v instanceof GameEnvironment.Yellow) {
          return Color_Scheme_Clrs.yellow;
      };
      throw new Error("Failed pattern match at Main (line 82, column 1 - line 82, column 34): " + [ v.constructor.name ]);
  };
  var handleAction = function (dictMonadEffect) {
      return function (v) {
          if (v instanceof Play) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(GameEnvironment.createInitialEnv))(function (newEnv) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      ...
                      $32.env = newEnv;
                      $32.but = false;
                      $32.colours = Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(8)(Color_Scheme_Clrs.gray);
                      return $32;
                  });
              });
          };
          if (v instanceof SelectColour) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      var colour = CanvasComponent.findColour(environment)(v.value0);
                      var newColours = Data_Array.modifyAt(v.value0 - 1 | 0)(function (v1) {
                          return colorConverter(colour);
                      })(colours);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                          ...
                          $35.colours = maybeColors(newColours);
                          return $35;
                      }))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              return v1.open;
                              ...
                              var partner = CanvasComponent.getPartner(environment)(v.value0);
                              var $42 = open === partner;
                              if ($42) {
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                      var $43 = {};
                              ...
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                  ...
                                  $46.open = 0;
                                  $46.colours = Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(8)(Color_Scheme_Clrs.gray);
                                  return $46;
                              });
                          });
                      });
          ...
          throw new Error("Failed pattern match at Main (line 93, column 16 - line 117, column 58): " + [ v.constructor.name ]);
      };
  };
  ...
  exports["colourString"] = colourString;
  exports["initialState"] = initialState;
  exports["justColor"] = justColor;
  exports["render"] = render;
  exports["colorConverter"] = colorConverter;
  exports["maybeColors"] = maybeColors;
